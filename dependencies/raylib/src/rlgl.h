...
typedef enum {
    ...
    RL_SHADER_UNIFORM_DOUBLE,             // Shader uniform type: double
    RL_SHADER_UNIFORM_DVEC2,             // Shader uniform type: dvec2 (2 double)
...
void rlSetUniform(int locIndex, const void *value, int uniformType, int count)
{
    ...
    switch (uniformType)
    {
        ...
        case RL_SHADER_UNIFORM_DOUBLE: glUniform1dv(locIndex, count, (double*)value); break;
        case RL_SHADER_UNIFORM_VEC2: glUniform2fv(locIndex, count, (float *)value); break;
        case RL_SHADER_UNIFORM_DVEC2: glUniform2dv(locIndex, count, (double*)value); break;
